<template>
    <AppLayout>
        ...
        <div class="grid grid-cols-1 gap-8 m-8 lg:m-10 lg:grid-cols-2">
                ...
                <form>
                    <div class="px-2 py-5 bg-white sm:p-6">
                        <div class="grid grid-cols-6 gap-6">
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="text" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm sm:text-sm"
                                    :value="$props.users.name" disabled />
                            </div>
                            ...
                            <div class="col-span-6 sm:col-span-2">
                                ...
                                <input type="number"
                                    class="block w-full mt-1 border-gray-300 rounded-md shadow-sm sm:text-sm" :value="new Date().getUTCFullYear() -
                                        new Date(
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                <label class="block text-sm font-medium text-gray-700">Net Proceeds Received</label>
                                <div>
                                    <span class="absolute mt-1.5 pl-2 font-bold">&#8369</span>
                        ...
                        <div class="col-span-6 mt-2 sm:col-span-2">
                            ...
                            <input type="text" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm sm:text-sm"
                                :value="new Date($props.loans.created_at)" disabled />
                        </div>
                    </div>
                </form>
            </div>

            <div v-if="loans.approval != 'Released' &&
            ...
            <div v-if="loans.approval == 'For Release'" class="content-center bg-white rounded-lg shadow-xl lg:mr-50">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <tr v-for="contribution in contributions.data" v-bind:key="contribution.id">
                            <td class="px-6 py-6 whitespace-nowrap">
                                <div class="">
                                    <div>
                                        <div class="px-8 text-sm font-medium text-center text-gray-900">
                                            {{ contribution.id }}
                                        </div>
                                    </div>
                                </div>
            ...
            <div v-if="loans.approval == 'Released'" class="text-xl font-semibold md:hidden">
                Breakdown of Loan Payment
            </div>
            <div class="grid grid-cols-1 gap-4 md:hidden" v-for="contribution in contributions.data"
            ...
            <div v-if="loans.approval == 'Denied'"
...
export default {
    ...
    methods: {
        loan() {
            this.$inertia.get(route("userDashboard"))
        }
    }
};
</script>
